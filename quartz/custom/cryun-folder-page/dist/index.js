...
function mostRecentDatesFromChildren(children) {
  return mostRecentDatesFromEntries(children.flatMap((child) => (child.data ? [child.data] : [])))
}
function buildFolderCardPreview(node) {
  ...
  return folder.children
    .map((node) => {
      ...
      if (nodeData) {
        ...
        if (node.isFolder) {
          if (!showSubfolders) return void 0
          return {
            ...nodeData,
  ...
  const FolderContent = (props) => {
    ...
    const content =
      hastRoot.children.length === 0
        ...
        : htmlToJsx(fileData.filePath ?? "content/index.md", hastRoot)
    const pageListContent = PageList(listProps)
    return /* @__PURE__ */ jsxs4("div", {
      class: "popover-hint folder-content-view",
      children: [
...
var src_default = CryunFolderPage
export { CryunFolderPage, src_default as default }
